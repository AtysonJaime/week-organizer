  ...
  <section class="hero is-info is-medium">
    ...
    <div class="hero-body">
      <div class="container has-text-centered">
        <p class="title is-1 is-spaced">Weekly Organizer</p>
        <p class="subtitle is-3">Modo simples para você organizar suas tarefas produzidas na semana.</p>
      </div>
    </div>
        ...
        <div class="container">
          <ul>
            <li :class="{ 'is-active': isAtividades }">
              <a @click="changeTab('Atividades')" title="Acessar Atividades Realizadas" tabindex="0" @keyup.enter="changeTab('Atividades')">
            ...
            <li :class="{ 'is-active': isReunioes }">
              <a @click="changeTab('Reunioes')" title="Acessar Reuniões" tabindex="0" @keyup.enter="changeTab('Reunioes')">
                <span class="icon is-small"><i class="fas fa-users" aria-hidden="true"></i></span>
                <span>Reuniões</span>
              </a>
            </li>
            <li :class="{ 'is-active': isOutros }">
              <a @click="changeTab('Outros')" title="Acessar Ajudas e Estudos" tabindex="0" @keyup.enter="changeTab('Outros')">
                <span class="icon is-small">
            ...
            <li :class="{ 'is-active': isDificuldades }">
              <a @click="changeTab('Dificuldades')" title="Acessar Dificuldades" tabindex="0" @keyup.enter="changeTab('Dificuldades')">
